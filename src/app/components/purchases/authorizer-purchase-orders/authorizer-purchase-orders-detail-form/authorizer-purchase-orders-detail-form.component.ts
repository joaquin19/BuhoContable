...
@Component({
  selector: 'app-authorizer-purchase-orders-detail-form',
  templateUrl: './authorizer-purchase-orders-detail-form.component.html',
  styleUrls: ['./authorizer-purchase-orders-detail-form.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class AuthorizerPurchaseOrdersDetailFormComponent implements OnInit {
